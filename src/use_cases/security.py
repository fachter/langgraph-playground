...
from ..viewmodels.user_model import UserModel
...
class GetAuthenticatedUserUseCase:
    ...
    def get(self, token: str):
        ...
        try:
            ...
            return self._get_user_from_username(
                payload.get("sub"), credentials_exception
            )
        except JWTError:
            raise credentials_exception

    def _get_user_from_username(
        self, username: str, credentials_exception: HTTPException
    ):
        if username is None:
            raise credentials_exception
